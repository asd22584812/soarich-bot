    ...
    const premiumFlexCard = {
      ...
      body: { type: "box", layout: "vertical", paddingAll: "26px", backgroundColor: "#1c1c1c", contents: [
        ...
        { type: "box", layout: "vertical", margin: "xl", spacing: "md", contents: [
            ...
            { type: "box", layout: "horizontal", contents: [{ type: "text", text: "施作項目", size: "xs", color: "#888888", flex: 2 }, { type: "text", text: `${serviceItem} (${durationHours}h)`, size: "xs", color: "#dfba73", weight: "bold", flex: 5 }]},
