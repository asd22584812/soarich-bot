...
// 5. 【SOARICH.STUDIO】黃金 6 席管理後台 (原始視覺風格)
app.get('/admin', async (req, res) => {
  try {
    ...
    <style>
        ...
        body { font-family: 'Noto Sans TC', sans-serif; background-image: url('https://images.unsplash.com/photo-1618220179428-22790b461013?q=80&w=1500&auto=format&fit=crop'); background-size: cover; background-attachment: fixed; background-position: center; padding: 60px 20px; color: #2c2c2c; letter-spacing: 0.5px; }
...
// 6. POST 與 Webhook 邏輯
app.post('/admin/add-customer', async (req, res) => { /* 這裡填入你原本的 POST 邏輯 */ });
